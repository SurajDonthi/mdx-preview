...
import { exportHtmlToPdf, downloadMdxFile } from '../utils/pdfExporter';
  ...
  const handleExportPdf = async () => {
    try {
      ...
      showToast(
        ...
        'Converting rendered preview into PDF layout...',
        'info',
        2500
      );

      await exportHtmlToPdf('mdx-preview-content', documentTitle);
      ...
      // Keep success state briefly visible in modal before closing
      setTimeout(() => {
      ...
      showToast('PDF Export Fallback', 'Opening system print dialog...', 'info');
      window.print();
      setIsGeneratingPdf(false);
      onClose();
    }
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Save or export your MDX document in multiple formats
              </p>
            </div>
          </div>
          <button
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900 dark:text-slate-100 text-sm flex items-center gap-2">
                  <span>
                    {isPdfSuccess
                      ? '✓ PDF Generated & Download Started!'
                      : isGeneratingPdf
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400">
                  {isPdfSuccess
                    ...
                    : 'Direct high-fidelity mobile-friendly PDF file download'}
                </div>
              </div>
            </div>
            {isPdfSuccess ? (
